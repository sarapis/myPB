          ...
          <div class="x_content">
            ...
            <div class="form-group m-form__group row">
                ...
                <div class="col-lg-4 col-md-9 col-sm-12">
                    ...
                    <img src="/images/{{$layout->logo}}" id="blah">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Site Tagline 
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="website" name="contact_btn_link" placeholder="www.website.com" class="form-control col-md-7 col-xs-12" value="{{$layout->contact_btn_link}}">
                </div>
              </div>
